...
import { AtSign, BadgeCheck, Brain, Check, CircleAlert, Coins, ExternalLink, Headphones, Info, KeyRound, LogOut, Mail, MessageCircle, Moon, Paperclip, Rocket, Settings, ShieldCheck, Sparkles, Trash2 } from 'lucide-react'
